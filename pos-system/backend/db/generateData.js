...
const client = new MongoClient('mongodb+srv://user:user123@pos-system.fel3r.mongodb.net/');
...
async function run() {
    try {
        ...
        await users.insertMany([
            { username: 'Admin1', password: '1234567890', type: 'admin' },
            { username: 'User1', password: '1234567890', type: 'user' }
        ]);
